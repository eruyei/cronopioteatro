...
!(function(a, b) {
  ...
  var c = (b.SliderPro.namespace = "SliderPro"),
    d = function(a, c) {
      (this.instance = a), (this.$slider = b(
        this.instance
      )), (this.$slides = null), (this.$slidesMask = null), (this.$slidesContainer = null), (this.slides = [
      ]), (this.slidesOrder = []), (this.options = c), (this.settings = {
      }), (this.originalSettings = {
      }), (this.originalGotoSlide = null), (this.selectedSlideIndex = 0), (this.previousSlideIndex = 0), (this.middleSlidePosition = 0), (this.supportedAnimation = null), (this.vendorPrefix = null), (this.transitionEvent = null), (this.positionProperty = null), (this.sizeProperty = null), (this.isIE = null), (this.slidesPosition = 0), (this.slidesSize = 0), (this.averageSlideSize = 0), (this.slideWidth = 0), (this.slideHeight = 0), (this.previousSlideWidth = 0), (this.previousSlideHeight = 0), (this.previousWindowWidth = 0), (this.previousWindowHeight = 0), (this.allowResize = !0), (this.uniqueId = new Date().valueOf()), (this.breakpoints = [
      ]), (this.currentBreakpoint = -1), (this.shuffledIndexes = [
      ]), this._init();
    };
  d.prototype = {
    _init: function() {
      var d = this;
      (this.supportedAnimation = f.getSupportedAnimation()), (this.vendorPrefix = f.getVendorPrefix()), (this.transitionEvent = f.getTransitionEvent()), (this.isIE = f.checkIE()), this.$slider.removeClass(
        "sp-no-js"
      ), a.navigator.userAgent.match(/(iPad|iPhone|iPod)/g) &&
        this.$slider.addClass("ios");
      var e = /(msie) ([\w.]+)/,
        g = e.exec(a.navigator.userAgent.toLowerCase());
      this.isIE && this.$slider.addClass("ie"), null !== g &&
        this.$slider.addClass(
          "ie" + parseInt(g[2], 10)
        ), (this.$slidesContainer = b(
        '<div class="sp-slides-container"></div>'
      ).appendTo(this.$slider)), (this.$slidesMask = b(
        '<div class="sp-mask"></div>'
      ).appendTo(this.$slidesContainer)), (this.$slides = this.$slider
        .find(".sp-slides")
        .appendTo(this.$slidesMask)), this.$slider
        .find(".sp-slide")
      ...
      if ("undefined" != typeof h)
        for (var i = 0; i < h.length; i++) {
          var j =
            h[i].substring(0, 1).toLowerCase() + h[i].substring(1) + "Defaults";
      ...
      if (
        ((this.selectedSlideIndex = this.settings.startSlide), this.settings
          .shuffle === !0)
      ) {
        ...
        for (var o = this.shuffledIndexes.length - 1; o > 0; o--) {
          ...
          (this.shuffledIndexes[o] = this.shuffledIndexes[
            p
      ...
      b(a).on("resize." + this.uniqueId + "." + c, function() {
        ...
        .addClass("sp-selected"), this.trigger({ type: "init" }), b.isFunction(
        this.settings.init
    ...
    update: function() {
      ...
      (this.slidesOrder.length = 0), this.$slider
        .find(".sp-slide")
        .each(function(c) {
          var d = b(this);
        ...
        10
      )), this.settings.loop === !0 && this._updateSlidesOrder(), this.trigger({
        type: "update"
      }), b.isFunction(this.settings.update) &&
    ...
    _updateSlidesOrder: function() {
      var a,
        c,
        d =
          b.inArray(this.selectedSlideIndex, this.slidesOrder) -
      ...
      if (0 > d)
        ...
        for (
          (a = this.slidesOrder.splice(0, d)), (c = 0);
          c <= a.length - 1;
          c++
        )
      ...
      if (
        ...
        for (c = this.middleSlidePosition; c >= 0; c--)
          (a = this.getSlideAt(this.slidesOrder[c])), (b = a.$slide), b.css(
            ...
            parseInt(b.css(this.positionProperty), 10) +
            a.getSize()[this.sizeProperty] +
            this.settings.slideDistance);
        for (
          (e = d), (c = this.middleSlidePosition + 1);
          c < this.slidesOrder.length;
          c++
        )
          (a = this.getSlideAt(this.slidesOrder[c])), (b = a.$slide), b.css(
            this.positionProperty,
            e - (a.getSize()[this.sizeProperty] + this.settings.slideDistance)
        ...
        for (
          (e = d), (c = this.middleSlidePosition);
          c < this.slidesOrder.length;
          c++
        )
          (a = this.getSlideAt(this.slidesOrder[c])), (b = a.$slide), b.css(
    ...
    _resetSlidesPosition: function() {
      ...
      if (
        ...
        for (c = 0; c < this.slidesOrder.length; c++)
          (a = this.getSlideAt(this.slidesOrder[c])), (b = a.$slide), b.css(
            this.positionProperty,
            d - (a.getSize()[this.sizeProperty] + this.settings.slideDistance)
    ...
    _calculateSlidesSize: function() {
      var a = this.$slides.find(".sp-slide").eq(this.slidesOrder[0]),
        ...
        d =
          parseInt(c.css(this.positionProperty), 10) +
          (this.settings.rightToLeft === !0 &&
            "horizontal" === this.settings.orientation
            ? -1
            : 1) *
            parseInt(c.css(this.sizeProperty), 10);
      (this.slidesSize = Math.abs(d - b)), (this.averageSlideSize = Math.round(
    ...
    resize: function() {
          ...
          for (var d = 0, e = this.breakpoints.length; e > d; d++)
            if (b(a).width() <= this.breakpoints[d].size) {
              if (this.currentBreakpoint !== this.breakpoints[d].size) {
                ...
                this.trigger(f), b.isFunction(this.settings.breakpointReach) &&
      ...
      this.settings.responsive === !0
        ...
        : this.$slider.css({ width: this.settings.width }), -1 ===
        this.settings.aspectRatio &&
        (this.settings.aspectRatio =
          this.settings.width /
          this.settings
            .height), (this.slideWidth = this.$slider.width()), "fullWindow" ===
        this.settings.forceSize
        ? (this.slideHeight = b(a).height())
        : (this.slideHeight = isNaN(this.settings.aspectRatio)
            ? this.settings.height
            : this.slideWidth / this.settings.aspectRatio), (this
        .previousSlideWidth !== this.slideWidth ||
        this.previousSlideHeight !== this.slideHeight ||
        "auto" !== this.settings.visibleSize ||
        this.$slider.outerWidth() > this.$slider.parent().width() ||
        this.$slider.width() !== this.$slidesMask.width()) &&
        ((this.previousSlideWidth = this.slideWidth), (this.previousSlideHeight = this.slideHeight), this._resizeSlides(), this.$slidesMask.css(
          { width: this.slideWidth, height: this.slideHeight }
          ...
          ("horizontal" === this.settings.orientation
            ...
            : ("fullWindow" === this.settings.forceSize
                ? this.$slider.css({ height: b(a).height(), "max-height": "" })
                : this.$slider.css({
                ...
                "height",
                this.$slider.height()
              ))), this._resetSlidesPosition(), this._calculateSlidesSize(), this.trigger(
          { type: "sliderResize" }
        ), b.isFunction(this.settings.sliderResize) &&
    ...
    _resizeSlides: function() {
      ...
      this.settings.autoSlideSize === !0
        ...
        : this.settings.autoHeight === !0 && (c = "auto"), b.each(
        this.slides,
        function(b, d) {
          d.setSize(a, c);
        }
    ...
    gotoSlide: function(a) {
      if (
        a !== this.selectedSlideIndex &&
        "undefined" != typeof this.slides[a]
      ) {
        var c = this;
        (this.previousSlideIndex = this.selectedSlideIndex), (this.selectedSlideIndex = a), this.$slides
          ...
          (this._updateSlidesOrder(), this._updateSlidesPosition()), this
          .settings.autoHeight === !0 && this._resizeHeight();
        ...
        if (
          ...
          (e["margin-" + this.positionProperty] = a), "undefined" != typeof b &&
            ...
            : (this.$slides.addClass(
                ...
                function() {
                  d.$slides.removeClass("sp-animated"), "function" ==
                    typeof c && c();
                }
              ));
        else {
          ...
          "css-3d" === this.supportedAnimation
            ? (e[this.vendorPrefix + "transform"] =
                "translate3d(" + g + "px, " + h + "px, 0)")
            : (e[this.vendorPrefix + "transform"] =
                "translate(" + g + "px, " + h + "px)"), "undefined" !=
            typeof b && b === !0
            ? (f = "")
            : (this.$slides.addClass("sp-animated"), (f =
                this.vendorPrefix +
                "transform " +
              ...
              })), (e[this.vendorPrefix + "transition"] = f), this.$slides.css(
            e
          );
        }
    },
    _stopMovement: function() {
      ...
      if (
        ...
        "css-3d" === this.supportedAnimation
          ...
          : (a[this.vendorPrefix + "transform"] =
              "translate(" + e + "px, " + f + "px)"), (a[
          this.vendorPrefix + "transition"
        ] =
          ""), this.$slides.css(a), this.$slides.off(
    ...
    destroy: function() {
      this.$slider.removeData("sliderPro"), this.$slider.removeAttr(
        "style"
      ), this.$slides.removeAttr("style"), this.off("update." + c), b(a).off(
      ...
      b.each(this.slides, function(a, b) {
        b.destroy();
      }), (this.slides.length = 0), this.$slides.prependTo(
        this.$slider
      ), this.$slidesContainer.remove();
    },
    _setProperties: function(a, b) {
      for (var c in a)
        (this.settings[c] = a[c]), b !== !1 &&
          (this.originalSettings[c] = a[c]);
      this.update();
    },
    on: function(a, b) {
  ...
  (e.prototype = {
    _init: function() {
      this.$slide.attr("data-init", !0), (this.$mainImage = 0 !==
        this.$slide.find(".sp-image").length
        ? this.$slide.find(".sp-image")
        : null), null !== this.$mainImage &&
        ((this.hasMainImage = !0), (this.$imageContainer = b(
          '<div class="sp-image-container"></div>'
        ).prependTo(this.$slide)), 0 !== this.$mainImage.parent("a").length
    ...
    setSize: function(a, b) {
      (this.width = a), (this.height = b), this.$slide.css({
        ...
        }), "undefined" == typeof this.$mainImage.attr("data-src") &&
    ...
    resizeMainImage: function(a) {
      var b = this;
      return a === !0 &&
        ((this.isMainImageLoaded = !1), (this.isMainImageLoading = !1)), this
        .isMainImageLoaded === !1 && this.isMainImageLoading === !1
        ...
        : (this.$imageContainer.css({
            ...
            })), void (this.settings.autoSlideSize === !0
            ? "horizontal" === this.settings.orientation
    ...
    destroy: function() {
      this.$slide.removeAttr("style"), this.$slide.removeAttr(
        "data-init"
      ), this.$slide.removeAttr("data-index"), this.$slide.removeAttr(
        "data-loaded"
      ), this.hasMainImage === !0 &&
        (this.$slide
          .find(".sp-image")
          .removeAttr("style")
          .appendTo(this.$slide), this.$slide
    ...
    getSupportedAnimation: function() {
      ...
      if (c === !0) {
        ...
        if (
          ...
          (e.textContent =
            "@media (transform-3d),(-webkit-transform-3d){#test-3d{left:9px;position:absolute;height:5px;margin:0;padding:0;border:0;}}"), document
            .getElementsByTagName("head")[0]
            .appendChild(e), (d.id = "test-3d"), document.body.appendChild(
            d
  ...
  var c = "Thumbnails." + b.SliderPro.namespace,
    d = {
      ...
      initThumbnails: function() {
        var a = this;
        (this.thumbnails = []), this.on(
          "update." + c,
          b.proxy(this._thumbnailsOnUpdate, this)
        ), this.on(
          "sliderResize." + c,
          b.proxy(this._thumbnailsOnResize, this)
      ...
      _thumbnailsOnUpdate: function() {
        ...
        if (
          ((this.isThumbnailScroller = !0), null ===
        ...
        for (var e = this.thumbnails.length - 1; e >= 0; e--)
          if (
            0 ===
            this.$thumbnails.find('.sp-thumbnail[data-index="' + e + '"]')
              .length
          ) {
          ...
          : "bottom" === this.settings.thumbnailsPosition
              ...
              : "left" === this.settings.thumbnailsPosition
                  ...
                  : "right" === this.settings.thumbnailsPosition &&
                      (this.$thumbnailsContainer.addClass(
                        "sp-right-thumbnails"
                      ), (this.thumbnailsOrientation = "vertical")), this
          .settings.thumbnailPointer === !0
          ? this.$thumbnailsContainer.addClass("sp-has-pointer")
          : this.$thumbnailsContainer.removeClass(
              "sp-has-pointer"
            ), (this.selectedThumbnailIndex = this.selectedSlideIndex), this.$thumbnails
          .find(".sp-thumbnail-container")
          .eq(this.selectedThumbnailIndex)
          .addClass(
            "sp-selected-thumbnail"
          ), (this.thumbnailsSize = 0), b.each(this.thumbnails, function(b, c) {
          c.setSize(
        ...
        }), b.isFunction(this.settings.thumbnailsUpdate) &&
          ...
          "horizontal" === this.thumbnailsOrientation
            ...
            : "vertical" === this.thumbnailsOrientation &&
                (this.$slidesMask.width() +
                  ...
                  "height",
                  this.thumbnailsContainerSize
                )), (c = this.thumbnailsSize <= this.thumbnailsContainerSize ||
        ...
        if (
          ...
          if (
            ((this.selectedThumbnailIndex = a), this.$thumbnails
              ...
              !0 && "horizontal" === this.thumbnailsOrientation)
          ) {
        ...
        if (a !== this.thumbnailsPosition)
          if (
            ((this.thumbnailsPosition = a), "css-3d" ===
              this.supportedAnimation || "css-2d" === this.supportedAnimation)
          ) {
            var g,
              h = "horizontal" === this.thumbnailsOrientation ? a : 0,
              i = "horizontal" === this.thumbnailsOrientation ? 0 : a;
            "css-3d" === this.supportedAnimation
              ? (f[this.vendorPrefix + "transform"] =
                  "translate3d(" + h + "px, " + i + "px, 0)")
              : (f[this.vendorPrefix + "transform"] =
                  "translate(" + h + "px, " + i + "px)"), "undefined" !=
              typeof c && c === !0
              ? (g = "")
              : (this.$thumbnails.addClass("sp-animated"), (g =
                  this.vendorPrefix +
      ...
      _stopThumbnailsMovement: function() {
        ...
        if (
          ...
          "css-3d" === this.supportedAnimation
            ...
            ""), this.$thumbnails.css(a), this.$thumbnails.off(
            this.transitionEvent
      ...
      destroyThumbnails: function() {
        var d = this;
        this.off("update." + c), this.isThumbnailScroller !== !1 &&
          (this.off("sliderResize." + c), this.off("gotoSlide." + c), b(a).off(
            "resize." + this.uniqueId + "." + c
          ...
          }), (this.thumbnails.length = 0), this.$thumbnails.appendTo(
            this.$slider
          ), this.$thumbnailsContainer.remove(), this.$slider.css({
            paddingTop: "",
            paddingLeft: "",
            paddingRight: ""
          }));
  ...
  (e.prototype = {
    _init: function() {
      var a = this;
      this.$thumbnail.attr("data-init", !0), (this.$thumbnailContainer = b(
        '<div class="sp-thumbnail-container"></div>'
      ).appendTo(this.$thumbnails)), 0 !== this.$thumbnail.parent("a").length
    ...
    destroy: function() {
      this.$thumbnailContainer.off("click." + c), this.$thumbnail.removeAttr(
        "data-init"
      ), this.$thumbnail.removeAttr("data-index"), 0 !==
        this.$thumbnail.parent("a").length
    ...
    d = {
      ...
      initConditionalImages: function() {
        (this.currentImageSize = this.previousImageSize =
          "default"), (this.isRetinaScreen =
          "undefined" != typeof this._isRetina &&
          this._isRetina() === !0), this.on(
          "update." + c,
          b.proxy(this._conditionalImagesOnUpdate, this)
        ), this.on(
          "sliderResize." + c,
          b.proxy(this._conditionalImagesOnResize, this)
        );
      },
          ...
          (this.slideWidth <= this.settings.smallSize
            ...
            : this.slideWidth <= this.settings.mediumSize
                ...
                : this.slideWidth <= this.settings.largeSize
                    ...
                    : (this.currentImageSize = "default"), this
            .previousImageSize !== this.currentImageSize)
        ) {
          var a = this;
              ...
              a.isRetinaScreen === !0 &&
                ...
                : (a.isRetinaScreen === !1 ||
                    (a.isRetinaScreen === !0 &&
                      "undefined" == typeof c.attr("data-retina"))) &&
                    "undefined" !=
                      typeof c.attr("data-" + a.currentImageSize) &&
                ...
                c.attr("src") !== e &&
                a._loadConditionalImage(c, e, function(a) {
                  a.hasClass("sp-image") &&
      ...
      _loadConditionalImage: function(a, c, d) {
        var e = b(new Image());
        e.attr("class", a.attr("class")), e.attr(
          "style",
          a.attr("style")
        ), b.each(a.data(), function(a, b) {
          e.attr("data-" + a, b);
        }), "undefined" != typeof a.attr("width") &&
          e.attr("width", a.attr("width")), "undefined" !=
          typeof a.attr("height") &&
          e.attr("height", a.attr("height")), "undefined" !=
          typeof a.attr("alt") && e.attr("alt", a.attr("alt")), "undefined" !=
          typeof a.attr("title") && e.attr("title", a.attr("title")), e.attr(
          "src",
          c
        ), e.insertAfter(a), a.remove(), (a = null), "function" == typeof d &&
          d(e);
      },
  ...
  var c = "Retina." + b.SliderPro.namespace,
    d = {
      initRetina: function() {
        this._isRetina() !== !1 &&
          (this.on("update." + c, b.proxy(this._checkRetinaImages, this)), 0 !==
      ...
      _loadRetinaImage: function(a, c) {
        ...
        if (
          ...
          f.attr("class", a.attr("class")), f.attr(
            ...
            typeof a.attr("alt") && f.attr("alt", a.attr("alt")), "undefined" !=
            typeof a.attr("title") &&
    ...
    d = {
      ...
      initLazyLoading: function() {
        this.on(
          ...
          "gotoSlide." + c,
          b.proxy(this._checkAndLoadVisibleImages, this)
        ), this.on(
      ...
      _lazyLoadingOnResize: function() {
        ...
        this.allowLazyLoadingCheck !== !1 &&
          ((this.allowLazyLoadingCheck = !1), this._checkAndLoadVisibleImages(), 0 !==
            this.$slider.find(".sp-thumbnail").length &&
            this._checkAndLoadVisibleThumbnailImages(), setTimeout(function() {
      ...
      _loadImage: function(a, c) {
        var d = b(new Image());
        d.attr("class", a.attr("class")), d.attr(
          "style",
          a.attr("style")
        ), b.each(a.data(), function(a, b) {
          d.attr("data-" + a, b);
        }), "undefined" != typeof a.attr("width") &&
          d.attr("width", a.attr("width")), "undefined" !=
          typeof a.attr("height") &&
          d.attr("height", a.attr("height")), "undefined" !=
          typeof a.attr("alt") && d.attr("alt", a.attr("alt")), "undefined" !=
          typeof a.attr("title") && d.attr("title", a.attr("title")), d.attr(
          "src",
          a.attr("data-src")
        ), d.removeAttr("data-src"), d.insertAfter(
          a
        ), a.remove(), (a = null), "function" == typeof c && c(d);
      },
      destroyLazyLoading: function() {
        this.off("update." + c), this.off("gotoSlide." + c), this.off(
          "sliderResize." + c
        ), this.off("thumbnailsUpdate." + c), this.off(
          "thumbnailsMoveComplete." + c
        );
      }
    };
  ...
  var c = "Layers." + b.SliderPro.namespace,
    d = {
      ...
      initLayers: function() {
        this.on("update." + c, b.proxy(this._layersOnUpdate, this)), this.on(
          "sliderResize." + c,
          b.proxy(this._layersOnResize, this)
          ...
          this.$slide
            ...
            .each(function() {
              ...
              "undefined" == typeof c.layers &&
                (c.layers = [
                ]), c.layers.push(a), b(this).hasClass("sp-static") === !1 && ("undefined" == typeof c.animatedLayers && (c.animatedLayers = []), c.animatedLayers.push(a));
            });
        }), this.settings.waitForLayers === !0 &&
          (clearTimeout(
            this.waitForLayersTimer
          ), (this.waitForLayersTimer = setTimeout(function() {
            (c.layersGotoSlideReference =
              c.gotoSlide), (c.gotoSlide = c._layersGotoSlide);
      ...
      _layersOnResize: function() {
        ...
        this.settings.autoScaleLayers !== !1 &&
          (-1 === this.settings.autoScaleReference
            ...
            "undefined" != typeof d.layers &&
              b.each(d.layers, function(a, b) {
                b.scale(c);
              });
          }));
      },
      ...
      _layersOnGotoSlide: function(a) {
        this.previousSlideIndex !== this.selectedSlideIndex &&
          this.hideLayers(this.previousSlideIndex), this.showLayers(
          this.selectedSlideIndex
        );
      },
      ...
      destroyLayers: function() {
        this.off("update." + c), this.off("resize." + c), this.off(
          "gotoSlide." + c
  ...
  a.SliderProSlide.prototype.destroy = function() {
    "undefined" != typeof this.layers &&
      (b.each(this.layers, function(a, b) {
        b.destroy();
      }), (this.layers.length = 0)), "undefined" !=
      typeof this.animatedLayers && (this.animatedLayers.length = 0), e.apply(
      this
    );
  };
  var f = function(a) {
  ...
  (f.prototype = {
    _init: function() {
      this.$layer.attr("data-layer-init", !0), this.$layer.hasClass("sp-static")
        ? this._setStyle()
        : this.$layer.css({ visibility: "hidden" });
    },
    _setStyle: function() {
      (this.styled = !0), (this.data = this.$layer.data()), "undefined" !=
        typeof this.data.width &&
        this.$layer.css("width", this.data.width), "undefined" !=
        typeof this.data.height &&
        this.$layer.css("height", this.data.height), "undefined" !=
        typeof this.data.depth &&
        this.$layer.css("z-index", this.data.depth), (this.position = this.data
        .position
        ? this.data.position.toLowerCase()
        : "topleft"), -1 !== this.position.indexOf("right")
        ? (this.horizontalProperty = "right")
        : -1 !== this.position.indexOf("left")
            ? (this.horizontalProperty = "left")
            : (this.horizontalProperty = "center"), -1 !==
        this.position.indexOf("bottom")
    ...
    _setPosition: function() {
      ...
      (this.horizontalPosition = "undefined" != typeof this.data.horizontal
        ...
        : 0), (this.verticalPosition = "undefined" != typeof this.data.vertical
        ? this.data.vertical
        : 0), "center" === this.horizontalProperty
        ? (this.$layer.is("img") === !1 &&
            ("undefined" == typeof a ||
              ("undefined" != typeof a && -1 === a.indexOf("width"))) &&
            (this.$layer.css("white-space", "nowrap"), this.$layer.css(
              "width",
        ...
        ? (this.$layer.is("img") === !1 &&
            ("undefined" == typeof a ||
              ("undefined" != typeof a && -1 === a.indexOf("height"))) &&
            (this.$layer.css("white-space", "nowrap"), this.$layer.css(
              "height",
      ...
      if (
        ...
        var b = "center" === this.horizontalProperty
          ...
          c = "center" === this.verticalProperty
            ...
            : this.verticalProperty,
          d = {};
        (d[this.vendorPrefix + "transform-origin"] =
          this.horizontalProperty + " " + this.verticalProperty), (d[
          this.vendorPrefix + "transform"
        ] =
          "scale(" + this.scaleRatio + ")"), "string" !=
        ...
        if ("javascript" === this.supportedAnimation)
          this.$layer
            ...
            .animate({ opacity: 1 }, 1e3 * d, function() {
              -1 !== f &&
                (b.stayTimer = setTimeout(function() {
          ...
          var g = { opacity: 0, visibility: "visible" },
            h = { opacity: 1 },
            i = "";
          (g[this.vendorPrefix + "transform"] =
            "scale(" + this.scaleRatio + ")"), (h[
            this.vendorPrefix + "transform"
          ] =
            "scale(" + this.scaleRatio + ")"), (h[
            this.vendorPrefix + "transition"
          ] =
            "opacity " + d + "s"), "undefined" !=
            typeof this.data.showTransition &&
            ("left" === this.data.showTransition
              ...
              ? " translate3d(0, 0, 0)"
              : " translate(0, 0)"), (h[this.vendorPrefix + "transition"] +=
              ", " +
              this.vendorPrefix +
              "transform " +
              d +
              "s")), this.$layer.on(this.transitionEvent, function(c) {
      ...
      if (this.visible !== !1) {
        ...
        if (
          ...
          this.$layer
            .stop()
            .delay(f)
            .animate({ opacity: 0 }, 1e3 * e, function() {
              b(this).css(
                "visibility",
                "hidden"
          ...
          (h[this.vendorPrefix + "transform"] =
            ...
            "opacity " + e + "s"), "undefined" !=
            typeof this.data.hideTransition &&
  ...
  var c = "Fade." + b.SliderPro.namespace,
    d = {
        ...
        if (a !== this.selectedSlideIndex)
          if (this.$slider.hasClass("sp-swiping"))
            ...
            b.each(this.slides, function(a, b) {
              ...
              .find(".sp-slide")
              .eq(this.selectedSlideIndex)
              .addClass("sp-selected"), e.settings.loop === !0 &&
              e._updateSlidesOrder(), this._moveTo(
              0,
              !0
              ...
              this._fadeSlideTo(d, 0), this.settings.autoHeight === !0 &&
              this._resizeHeight(), this.trigger({
              type: "gotoSlide",
              index: a,
              previousIndex: this.previousSlideIndex
            }), b.isFunction(this.settings.gotoSlide) &&
      ...
      _fadeSlideTo: function(a, b, c) {
        var d = this;
        1 === b && a.attr("data-transitioning", !0), "css-3d" ===
          this.supportedAnimation || "css-2d" === this.supportedAnimation
          ? (setTimeout(function() {
              var c = { opacity: b };
              (c[d.vendorPrefix + "transition"] =
                "opacity " + d.settings.fadeDuration / 1e3 + "s"), a.css(c);
      ...
      destroyFade: function() {
        this.off("update." + c), null !== this.fadeGotoSlideReference &&
    ...
    d = {
      ...
      initTouchSwipe: function() {
        this.settings.touchSwipe !== !1 &&
          ((this.touchSwipeEvents.startEvent =
            ...
            c +
            " mousedown." +
            c), (this.touchSwipeEvents.moveEvent =
            "touchmove." +
            c +
            " mousemove." +
            c), (this.touchSwipeEvents.endEvent =
            "touchend." +
            this.uniqueId +
            "." +
            c +
      ...
      _onTouchStart: function(a) {
        if (!(b(a.target).closest(".sp-selectable").length >= 1)) {
          ...
          "undefined" == typeof a.originalEvent.touches &&
            ...
            d.pageX || d.clientX), (this.touchStartPoint.y =
            d.pageY ||
            d.clientY), (this.touchStartPosition = this.slidesPosition), (this.touchDistance.x = this.touchDistance.y = 0), this.$slides.hasClass(
            "sp-animated"
          ) &&
            ...
            .removeClass("sp-grab")
            .addClass("sp-grabbing"), this.$slider.addClass("sp-swiping");
        }
      },
      _onTouchMove: function(a) {
        var b = "undefined" != typeof a.originalEvent.touches
          ? a.originalEvent.touches[0]
          : a.originalEvent;
        (this.isTouchMoving = !0), (this.touchEndPoint.x =
          b.pageX || b.clientX), (this.touchEndPoint.y =
          b.pageY || b.clientY), (this.touchDistance.x =
          this.touchEndPoint.x -
          this.touchStartPoint.x), (this.touchDistance.y =
      ...
      _onTouchEnd: function(a) {
        ...
        if (
          (this.$slidesMask.off(this.touchSwipeEvents.moveEvent), b(
            document
          ).off(this.touchSwipeEvents.endEvent), this.$slidesMask
            .removeClass("sp-grabbing")
            .addClass("sp-grab"), (this.isTouchMoving === !1 ||
            ...
            (b(a.target)
              .parents(".sp-slide")
              .find("a")
              .off("click." + c), this.$slider.removeClass(
              "sp-swiping"
            )), setTimeout(function() {
            d.$slider.removeClass("sp-swiping");
          }, 1), this.isTouchMoving !== !1)
        ) {
          (this.isTouchMoving = !1), b(a.target)
            .parents(".sp-slide")
            .one("click", function(a) {
              a.preventDefault();
            });
          var f = this.settings.centerSelectedSlide === !0
            ? Math.round(
                (parseInt(this.$slidesMask.css(this.sizeProperty), 10) -
                  this.getSlideAt(this.selectedSlideIndex).getSize()[
                    this.sizeProperty
          ...
          if (Math.abs(e) < this.settings.touchSwipeThreshold) this._moveTo(g);
            ...
            var i = this.slidesOrder[
              b.inArray(this.selectedSlideIndex, this.slidesOrder) - h
            ];
            this.settings.loop === !0
              ? this.gotoSlide(i)
              : "undefined" != typeof i ? this.gotoSlide(i) : this._moveTo(g);
          }
        }
      },
      destroyTouchSwipe: function() {
        this.$slidesMask.off(
          ...
          this.touchSwipeEvents.moveEvent
        ), this.$slidesMask.off("dragstart." + c), b(document).off(
          this.touchSwipeEvents.endEvent
  ...
  var c = "Caption." + b.SliderPro.namespace,
    d = {
      ...
      initCaption: function() {
        this.on("update." + c, b.proxy(this._captionOnUpdate, this)), this.on(
          "gotoSlide." + c,
          b.proxy(this._updateCaptionContent, this)
        );
      },
      _captionOnUpdate: function() {
        (this.$captionContainer = this.$slider.find(
          ...
          ((this.$captionContainer = b(
            '<div class="sp-caption-container"></div>'
          ).appendTo(
            this.$slider
          )), this._updateCaptionContent()), this.$slides
          .find(".sp-caption")
          .each(function() {
      ...
      _fadeCaptionTo: function(a, b) {
        ...
        "css-3d" === this.supportedAnimation ||
          ...
          ? (setTimeout(function() {
              var b = { opacity: a };
              (b[c.vendorPrefix + "transition"] =
                "opacity " +
                c.settings.captionFadeDuration / 1e3 +
      ...
      destroyCaption: function() {
        this.off("update." + c), this.off(
          "gotoSlide." + c
        ), this.$captionContainer.remove(), this.$slider
          .find(".sp-caption")
          .each(function() {
            b(this).css("display", "");
          });
  ...
  var c = "DeepLinking." + b.SliderPro.namespace,
    d = {
      initDeepLinking: function() {
        ...
        this.on("init." + c, function() {
          ...
          if (d.settings.updateHash === !0) {
            ...
            "undefined" == typeof c && (c = b.index), (a.location.hash =
              d.$slider.attr("id") + "/" + c);
          }
      ...
      destroyDeepLinking: function() {
        this.off("init." + c), this.off("gotoSlide." + c), b(a).off(
          "hashchange." + this.uniqueId + "." + c
        );
      },
  ...
  var c = "Autoplay." + b.SliderPro.namespace,
    d = {
      ...
      _autoplayOnGotoSlide: function(a) {
        this.isTimerRunning === !0 && this.stopAutoplay(), this
          .isTimerPaused === !1 && this.startAutoplay();
      },
      ...
      stopAutoplay: function() {
        (this.isTimerRunning = !1), (this.isTimerPaused = !1), clearTimeout(
          this.autoplayTimer
        );
      },
      destroyAutoplay: function() {
        clearTimeout(this.autoplayTimer), this.off("update." + c), this.off(
          "gotoSlide." + c
        ), this.off("mouseenter." + c), this.off("mouseleave." + c);
      },
      autoplayDefaults: {
        autoplay: !0,
        autoplayDelay: 5e3,
  ...
  var c = "Keyboard." + b.SliderPro.namespace,
    d = {
      ...
      destroyKeyboard: function() {
        this.$slider.off("focus." + c), this.$slider.off("blur." + c), b(
          document
        ).off("keydown." + this.uniqueId + "." + c);
      },
  ...
  var c = "FullScreen." + b.SliderPro.namespace,
    d = {
      ...
      _fullScreenOnUpdate: function() {
        this.settings.fullScreen === !0 && null === this.$fullScreenButton
          ...
          : this.settings.fullScreen === !1 &&
              ...
              this._removeFullScreen(), this.settings.fullScreen === !0 &&
      ...
      _addFullScreen: function() {
        ...
        ).appendTo(this.$slider)), this.$fullScreenButton.on(
          "click." + c,
          b.proxy(this._onFullScreenButtonClick, this)
      ...
      _onFullScreenChange: function() {
        (this.isFullScreen = document.fullscreenElement ||
          ...
          ? ((this.sizeBeforeFullScreen = {
              ...
              "fullWindow"), (this.settings.autoHeight = !1))
          : (this.$slider.css("margin", ""), this.$slider.removeClass(
              "sp-full-screen"
            ), (this.settings.forceSize = this.sizeBeforeFullScreen.forceSize), (this.settings.autoHeight = this.sizeBeforeFullScreen.autoHeight)), this.resize();
      },
    ...
    d = {
      ...
      _createButtons: function() {
        ...
        this.$buttons.on("click." + c, ".sp-button", function() {
          ...
          .find(".sp-button")
          .eq(this.selectedSlideIndex)
          .addClass("sp-selected-button"), this.on("gotoSlide." + c, function(
          b
        ) {
          a.$buttons
            .find(".sp-selected-button")
            .removeClass("sp-selected-button"), a.$buttons
            .find(".sp-button")
            .eq(b.index)
      ...
      _adjustButtons: function() {
        ...
        this.$buttons
          .find(".sp-selected-button")
          .removeClass("sp-selected-button"), this.$buttons
          .find(".sp-button")
          .eq(this.selectedSlideIndex)
          .addClass("sp-selected-button");
      },
      _removeButtons: function() {
        this.$buttons.off("click." + c, ".sp-button"), this.off(
          "gotoSlide." + c
        ), this.$buttons.remove(), this.$slider.removeClass("sp-has-buttons");
      },
  ...
  var c = "Arrows." + b.SliderPro.namespace,
    d = {
      ...
      $nextArrow: null,
      initArrows: function() {
        this.on("update." + c, b.proxy(this._arrowsOnUpdate, this)), this.on(
          "gotoSlide." + c,
          b.proxy(this._checkArrowsVisibility, this)
        );
      },
      _arrowsOnUpdate: function() {
        ...
        this.settings.arrows === !0 && null === this.$arrows
          ...
          : this.settings.arrows === !1 &&
              null !== this.$arrows &&
              this._removeArrows(), this.settings.arrows === !0 &&
          (this.settings.fadeArrows === !0
            ? this.$arrows.addClass("sp-fade-arrows")
            : this.settings.fadeArrows === !1 &&
      ...
      _checkArrowsVisibility: function() {
        this.settings.arrows !== !1 &&
          ...
          (0 === this.selectedSlideIndex
            ...
            : this.$previousArrow.css("display", "block"), this
            .selectedSlideIndex ===
            this.getTotalSlides() - 1
      ...
      destroyArrows: function() {
        this._removeArrows(), this.off("update." + c), this.off(
          "gotoSlide." + c
        );
      },
    ...
    d = {
      ...
      _thumbnailTouchSwipeOnUpdate: function() {
        this.isThumbnailScroller !== !1 &&
          (this.settings.thumbnailTouchSwipe === !0 &&
            ...
            ((this.isThumbnailTouchSwipe = !0), (this.thumbnailTouchSwipeEvents.startEvent =
              "touchstart." +
              c +
              " mousedown." +
              c), (this.thumbnailTouchSwipeEvents.moveEvent =
              "touchmove." +
              c +
              " mousemove." +
              c), (this.thumbnailTouchSwipeEvents.endEvent =
              "touchend." +
              this.uniqueId +
              "." +
              c +
              ...
              a.preventDefault();
            }), this.$thumbnails.addClass("sp-grab")), b.each(
            this.thumbnails,
            function(a, b) {
      ...
      _onThumbnailTouchStart: function(a) {
        if (!(b(a.target).closest(".sp-selectable").length >= 1)) {
          ...
          "undefined" == typeof a.originalEvent.touches &&
            ...
            d.pageX || d.clientX), (this.thumbnailTouchStartPoint.y =
            d.pageY ||
      ...
      _onThumbnailTouchMove: function(a) {
        var b = "undefined" != typeof a.originalEvent.touches
          ? a.originalEvent.touches[0]
          : a.originalEvent;
        (this.isThumbnailTouchMoving = !0), (this.thumbnailTouchEndPoint.x =
          b.pageX || b.clientX), (this.thumbnailTouchEndPoint.y =
          b.pageY || b.clientY), (this.thumbnailTouchDistance.x =
          this.thumbnailTouchEndPoint.x -
          this.thumbnailTouchStartPoint.x), (this.thumbnailTouchDistance.y =
      ...
      _onThumbnailTouchEnd: function(a) {
        ...
        if (
          ...
          return void (0 !== b(a.target).parents("a").length
            ...
            : f !== this.selectedThumbnailIndex &&
                -1 !== f &&
                this.gotoSlide(f));
        }
        (this.isThumbnailTouchMoving = !1), b(a.target)
          .parents(".sp-thumbnail")
          .one("click", function(a) {
            a.preventDefault();
          }), setTimeout(function() {
          d.$thumbnailsContainer.removeClass("sp-swiping");
        }, 1), this.thumbnailsPosition > 0
          ? this._moveThumbnailsTo(0)
          : this.thumbnailsPosition <
              this.thumbnailsContainerSize - this.thumbnailsSize &&
              this._moveThumbnailsTo(
                this.thumbnailsContainerSize - this.thumbnailsSize
              ), this.trigger({ type: "thumbnailsMoveComplete" }), b.isFunction(
      ...
      destroyThumbnailTouchSwipe: function() {
        this.off("update." + c), this.isThumbnailScroller !== !1 &&
          (this.$thumbnails.off(
            ...
            this.thumbnailTouchSwipeEvents.moveEvent
          ), this.$thumbnails.off("dragstart." + c), b(document).off(
            this.thumbnailTouchSwipeEvents.endEvent
    ...
    d = {
      ...
      initThumbnailArrows: function() {
        ...
        this.on(
          ...
          function() {
            a.isThumbnailScroller === !0 &&
              a.settings.thumbnailArrows === !0 &&
      ...
      _checkThumbnailArrowsVisibility: function() {
        0 === this.thumbnailsPosition
          ...
          : this.$previousThumbnailArrow.css("display", "block"), this
          .thumbnailsPosition ===
          this.thumbnailsContainerSize - this.thumbnailsSize
      ...
      destroyThumbnailArrows: function() {
        this._removeThumbnailArrows(), this.off("update." + c), this.off(
          "sliderResize." + c
  ...
  var c = "Video." + b.SliderPro.namespace,
    d = {
      firstInit: !1,
      initVideo: function() {
        this.on("update." + c, b.proxy(this._videoOnUpdate, this)), this.on(
          "gotoSlideComplete." + c,
      ...
      _initVideo: function(a) {
        var d = this;
        a.attr("data-video-init", !0).videoController(), a.on(
          "videoPlay." + c,
          function() {
            ...
            d.trigger(c), b.isFunction(d.settings.videoPlay) &&
              d.settings.videoPlay.call(d, c);
          }
        ...
        a.attr("data-video-preinit", !0), a.on("click." + c, function(c) {
          if (!d.$slider.hasClass("sp-swiping")) {
            ...
            var e,
              ...
              n =
                a.children("img").attr("height") || a.children("img").height();
            -1 !== l.indexOf("youtube") || -1 !== l.indexOf("youtu.be")
              ? (f = "youtube")
              : -1 !== l.indexOf("vimeo") && (f = "vimeo"), (g = "youtube" === f
              ? /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/
              : /http:\/\/(www\.)?vimeo.com\/(\d+)/), (h = l.match(g)), (i =
              h[2]), (j = "youtube" === f
              ? "//www.youtube.com/embed/" + i + "?enablejsapi=1&wmode=opaque"
              : "//player.vimeo.com/video/" + i + "?api=1"), (k = l.split("?")[
              1
            ]), "undefined" != typeof k &&
              ((k = k.split("&")), b.each(k, function(a, b) {
                -1 === b.indexOf(i) && (j += "&" + b);
              })), (e = b("<iframe></iframe>")
              .attr({
                src: j,
              ...
              .insertBefore(a)), d._initVideo(e), e.videoController(
              "play"
            ), a.css("display", "none");
          }
        });
              ...
              : "pauseVideo" === this.settings.leaveVideoAction
                  ...
                  : "removeVideo" === this.settings.leaveVideoAction &&
                      (0 !== b.siblings("a.sp-video").length
                        ...
                        : b.videoController("stop"))), "playVideo" ===
  ...
  var b = window.navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1,
    c = function(b, c) {
      (this.$video = a(b)), (this.options = c), (this.settings = {
      }), (this.player = null), this._init();
    };
  (c.prototype = {
    _init: function() {
    ...
    destroy: function() {
      this.player.isStarted() === !0 && this.stop(), this.player.off(
        "ready"
      ), this.player.off("start"), this.player.off("play"), this.player.off(
        "pause"
      ), this.player.off("ended"), this.$video.removeData("videoController");
    },
    defaults: {
      videoReady: function() {},
      videoStart: function() {},
  ...
  var d = function(b) {
    (this.$video = b), (this.player = null), (this.ready = !1), (this.started = !1), (this.state =
      ""), (this.events = a({})), this._init();
  };
  d.prototype = {
    _init: function() {},
    play: function() {},
        ...
        onStateChange: function(b) {
          switch (b.data) {
            case YT.PlayerState.PLAYING:
              a.started === !1 &&
                ((a.started = !0), a.trigger({ type: "start" })), (a.state =
                "playing"), a.trigger({ type: "play" });
              break;
  ...
  (h.prototype = new d()), (h.prototype.constructor = h), a.VideoController.addPlayer(
    ...
    (this.player = $f(
      ...
      (a.ready = !0), a.trigger({ type: "ready" }), a.player.addEvent(
        "play",
        function() {
          a.started === !1 &&
            ((a.started = !0), a.trigger({ type: "start" })), (a.state =
  ...
  (j.prototype = new d()), (j.prototype.constructor = j), a.VideoController.addPlayer(
    ...
    (this.player = videojs(b)), this.player.ready(function() {
      (a.ready = !0), a.trigger({ type: "ready" }), a.player.on(
        "play",
        function() {
          a.started === !1 &&
            ((a.started = !0), a.trigger({ type: "start" })), (a.state =
